  ...
  <section id='awards'>
    <div className='main1'>
      <div id='heading1'>
        ...
        <img src="src/assets/spoon.png" alt="spoon" id='awards-spoon'/>
      </div>
      <div id='heading2'>
      ...
      <div id='awards-div'>
        <div id='carry1'>
          <div id='awards-subdiv1' className='subdiv'>
            <img src="src\assets\award02.png" alt="award2" id='award2' />
            <div id='award2-text'>
          ...
          <div id='awards-subdiv2' className='subdiv'>
            <img src="src\assets\award01.png" alt="award1" id='award1' />
            <div id='award2-text'>
        ...
        <div id='carry2'>
          <div id='awards-subdiv3' className='subdiv'>
            <img src="src\assets\award05.png" alt="award5" id='award5' />
            <div id='award2-text'>
          ...
          <img src="src\assets\award03.png" alt="award3" id='award3'/>
            <div id='award2-text'>
    ...
    <div className='main2'>
      <img src="src\assets\laurels.png" alt="laurels" id='laurels-img'/>
    </div>
  </section>
);
