...
const Chef = () => (
  <section id='sectionchef'>
    <div id='chef-img-div'>
      <img src="src\assets\chef.png" alt="chef" id='chef-img'/>
    </div>
    <div id='chef-text-div'>
      <div id='chef-word'>
        <h1>Chef-Word</h1>
        <img src="src/assets/spoon.png" alt="spoon" id='spoon-chef'/>
      </div>
      <div id='chef-slogan'>
      What we believe in
      </div>
      <div id='chef-lorem'>
        <img src="src\assets\quote.png" alt="qoute" id='chef-qoute' />
      ...
      <div id='chef-sign'>
        <img src="src\assets\sign.png" alt="sign" id='sign'/>
      </div>
    </div>
  </section>
);
